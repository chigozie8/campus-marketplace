...
export const metadata: Metadata = buildMetadata({
  title: 'VendoorX — Nigeria\'s Campus Marketplace on WhatsApp | UNILAG, ABU, UI, OAU & 100+ Universities',
  description:
    'VendoorX is the marketplace built for Nigerian university students. Buy and sell with classmates from UNILAG, ABU, UI, OAU, BUK, UNN, UNIBEN and 120+ campuses — all powered by WhatsApp. Free to join, zero commission.',
  path: '/',
  keywords: [
    ...
    'university WhatsApp marketplace',
    'buy from classmates Nigeria',
    'sell to students Nigeria',
    'campus side hustle Nigeria',
    'WhatsApp commerce Nigeria',
    'student seller platform Nigeria',
    'dorm marketplace Nigeria',
    'Nigerian college marketplace',
    'VendoorX',
    'vendoorx Nigeria',
  ],
})
...
const softwareAppJsonLd = {
  ...
  url: SITE_URL,
  description:
    'VendoorX is the campus marketplace for Nigerian university students. Buy and sell with classmates from 120+ Nigerian universities including UNILAG, ABU, UI, OAU and BUK — powered by WhatsApp.',
  offers: {
    '@type': 'Offer',
    price: '0',
    priceCurrency: 'NGN',
