  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] flex flex-col items-center justify-center px-6 text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-3 w-full max-w-xs">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><polyline points="23 4 23 10 17 10"/><path d="M20.49 15a9 9 0 1 1-2.12-9.36L23 10"/></svg>
          Try Again
        </button>
        <Link
          href="/"
        ...
        dangerouslySetInnerHTML={{
          __html: `
            window.addEventListener('online', function() {
              ...
              if (txt) txt.textContent = 'Back online — reloading…';
