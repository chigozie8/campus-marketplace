  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 40 40" className="w-6 h-6" fill="currentColor">
        ...
        <path d="M6 16h28v3H6zM6 22h28v3H6z" />
      </svg>
    ),
  },
  {
...
export function IntegrationsSection() {
  return (
    <section className="py-16 sm:py-20 px-4 sm:px-6 bg-muted/30 dark:bg-muted/10 border-y border-border">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-foreground text-balance">
            The tools your customers already use
          </h2>
        </div>

        {/* Logo row */}
        <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6">
          {INTEGRATIONS.map(({ name, color, textColor, icon }) => (
            <div
              key={name}
              className={cn(
                'group flex items-center gap-3 pl-3.5 pr-5 py-3 rounded-2xl transition-all duration-300',
        ...
        <p className="text-center text-sm text-muted-foreground mt-8">
          Share listings, receive payments, and manage orders — all from one place.
        </p>
      </div>
    </section>
  )
