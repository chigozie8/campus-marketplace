      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-foreground text-balance mb-4">
            The platforms your customers already use
          </h2>
          <p className="text-muted-foreground text-base sm:text-lg max-w-xl mx-auto leading-relaxed">
            Connect your store to every social platform. One dashboard — unlimited reach.
          </p>
        </div>
        ...
        <p className="text-center text-sm text-muted-foreground mt-10">
          Share listings, receive payments, and manage orders &mdash; all from one place.
        </p>
      </div>
    </section>
  )
