  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed z-40 bottom-[84px] left-4 sm:bottom-6 sm:left-auto sm:right-6 flex items-center gap-2 bg-white text-[#0a0a0a] border border-zinc-200 pl-2.5 pr-3.5 py-2 rounded-full shadow-xl shadow-black/30 hover:scale-105 active:scale-95 transition-all duration-200 ${
