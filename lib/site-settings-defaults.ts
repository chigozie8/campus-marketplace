...
export const DEFAULT_FAQS: FaqItem[] = [
  ...
  { category: 'Platform', q: 'Is VendoorX only for university students in Nigeria?', a: 'VendoorX is focused on Nigerian campuses and university students, but anyone can use the platform. We currently serve 120+ campuses across Nigeria including UNILAG, UI, OAU, FUTA, ABU, BUK, EBSU, and AE-FUNIA.' },
...
export const DEFAULT_SETTINGS: SiteSettings = {
  ...
  press_founder_title: 'Founder, CEO & Senior Software Engineer',
  press_founder_initials: 'KO',
  press_founder_photo: '',
  press_founder_bio: 'Kenneth Okoronkwo is the founder, CEO, and lead engineer of VendoorX — Nigeria\'s #1 campus commerce platform. A senior software engineer with deep expertise in full-stack development, distributed systems, and product architecture, Kenneth built VendoorX from the ground up to bring structured, professional commerce to Nigerian university campuses.',
  press_founder_bio2: 'Under his technical and strategic leadership, VendoorX has grown to serve 50,000+ vendors across 120+ Nigerian universities, processing over ₦2 billion in verified transactions. Kenneth writes about engineering, product, and African tech on the VendoorX blog.',
